        ...
        public async Task<List<StudentPollPortuguese>> ListStudentPollPortuguese(ClassRoomFilter classRoom)
        {
            try
            {
                ...
                using (Contexts.SMEManagementContext db = new Contexts.SMEManagementContext())
                {
                    ...
                    listStudentsClassRoom = listStudentsClassRoom.Where(x => x.CodigoSituacaoMatricula == 10 || x.CodigoSituacaoMatricula == 1 || x.CodigoSituacaoMatricula == 6 || x.CodigoSituacaoMatricula == 13).ToList(); // 1 ativo,10 rematriculado,6-pendente de rematricula
