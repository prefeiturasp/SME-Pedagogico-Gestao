...
namespace SME.Pedagogico.Gestao.Data.Business
{
    public class SondagemAutoralBusiness
    {
        ...
        private bool ExibirNumeroDaAquestao(int anoEscolar,int bimestre)
        {
        ...
        private async Task<List<PerguntaDto>> ObterPerguntas(int anoEscolar, List<PerguntaDto> perguntas, int anoLetivo, SMEManagementContextData contexto,int bimestre)
        {
            try
            {
                ...
                var numeracaoNaDescricaoDaQuestao = ExibirNumeroDaAquestao(anoEscolar, bimestre) ? $@" 'Questão '|| pae.""Ordenacao""|| ': ' || p.""Descricao"" as ""PerguntaDescricao"",  " : $@" p.""Descricao"" as ""PerguntaDescricao"",  ";
