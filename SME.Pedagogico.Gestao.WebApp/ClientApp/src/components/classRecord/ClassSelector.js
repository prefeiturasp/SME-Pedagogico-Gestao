                ...
                <Spring
                    ...
                    {props =>
                        <animated.div id="class-selector-submenu" className="" style={props}>
                            <div className="py-2 px-4 d-flex align-items-center">
                                <Select className="" defaultText="Ano" options={options} />
                                <div className="px-2"></div>
                                <Select className="col-4" defaultText="Selecione a DRE" options={options} />
                                <div className="px-2"></div>
                                <Select className="col-4" defaultText="Escola" options={options} />
                                <div className="px-2"></div>
