              ...
              if (item.tipoPeriodicidade === TIPO_PERIODO.BIMESTRE) {
                  ...
                  if (item.bimestre === 1) {
                      if (
                          ...
                          if (this.props.pollOptionSelectLock.set_poll_1s_lock !== false) 
                              this.props.pollOptionSelectLockMethods.set_poll_1s_lock(false);
                      } else {
                          if (this.props.pollOptionSelectLock.set_poll_1s_lock !== true)
                      ...
                      if (
                          ...
                          if (this.props.pollOptionSelectLock.set_poll_2s_lock !== false) 
                              this.props.pollOptionSelectLockMethods.set_poll_2s_lock(false);
                      } else {
                          if (this.props.pollOptionSelectLock.set_poll_2s_lock !== true) 
