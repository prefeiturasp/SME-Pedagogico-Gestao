...
class SondagemClassSelected extends Component {
  constructor(props) {
    ...
    if (this.props.poll.selectedFilter.schoolYear < 2022) {
      if (this.props.poll.pollTypeSelected === "Numeric") {
        ...
        this.props.pollMethods.get_poll_math_ca_students(
          this.props.poll.selectedFilter
        );
      } else if (this.props.poll.pollTypeSelected === "CM") {
        this.props.pollMethods.get_poll_math_cm_students(
          this.props.poll.selectedFilter
        );
      }
    }

    this.toggleMessageMathNumericBox =
      this.toggleMessageMathNumericBox.bind(this);
  ...
  btnCheckNumeric() {
    var numericStyle =
      "btn btn-outline-primary btn-sm btn-matematica btn-double-left border-right-0";
    if (this.props.poll.pollTypeSelected === "Numeric") {
  ...
  btnCheckCA() {
    var caStyle1 =
      "btn btn-outline-primary btn-sm btn-matematica btn-double-right border-left-0";
    var caStyle2 =
      "btn btn-outline-primary btn-sm btn-matematica border-left-0 border-right-0";
    var caStyle3 =
      "btn btn-outline-primary btn-sm btn-matematica btn-double-left border-right-0";
    if (
      this.props.poll.pollTypeSelected === "CA" &&
      this.props.poll.pollYear === "1"
    ) {
      return caStyle1 + " active";
    } else if (
      this.props.poll.pollTypeSelected === "CA" &&
      (this.props.poll.pollYear === "2" || this.props.poll.pollYear === "3")
    ) {
  ...
  render() {
    ...
    switch (String(this.props.poll.pollYear)) {
      case "1":
          ...
          buttonRender = (
            ...
            >
              <button
                id="1Numeric"
                value="Numeric"
                onClick={this.toggleMessageMathNumericBox}
                type="button"
                className={this.btnCheckNumeric()}
              >
                1º ano - Números
              </button>
              <button
                id="1CA"
                value="CA"
                onClick={this.toggleMessageMathCaBox}
                type="button"
                className={this.btnCheckCA()}
              >
                1º ano - CA
              </button>
            </div>
          ...
          buttonRender = (
            ...
            >
              ...
              <button
                id="2CM"
                value="CM"
                onClick={this.toggleMessageMathCmBox}
                type="button"
                className={this.btnCheckCM()}
              >
                2º ano - CM
              </button>
            </div>
