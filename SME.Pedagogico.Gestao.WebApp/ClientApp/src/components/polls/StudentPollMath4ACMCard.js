            ...
            <table className="table table-sm table-bordered table-hover table-sondagem-matematica" style={{ overflow: "hidden", overflowX: "auto" }}>
                    <thead>
                        <tr>
                            ...
                            <th colSpan="8" className="text-center border sondagem-matematica-title" id="ordem5_head"><span style={pStyle}>&#60;</span><b className="p-4">Ordem 5 - ideia: CONFIGURAÇÃO RETANGULAR</b><span value="ordem6" onClick={this.hideShowOrdem} className="testcursor">&#62;</span></th>
                            <th colSpan="8" className="text-center border sondagem-matematica-title" id="ordem6_head"><span value="ordem5" onClick={this.hideShowOrdem} className="testcursor">&#60;</span><b className="p-4">Ordem 6 - ideia: PROPORCIONALIDADE</b><span value="ordem7" onClick={this.hideShowOrdem} className="testcursor">&#62;</span></th>
                            <th colSpan="8" className="text-center border sondagem-matematica-title" id="ordem7_head"><span value="ordem6" onClick={this.hideShowOrdem} className="testcursor">&#60;</span><b className="p-4">Ordem 7 - ideia: COMBINATÓRIA</b><span style={pStyle}>&#62;</span></th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <th colSpan="4" className="text-center border poll-select-container ordem6_col"><small className="text-muted">2ºB</small></th>
                            <th colSpan="4" className="text-center border poll-select-container ordem6_col"><small className="text-muted">4ºB</small></th>
                            <th colSpan="4" className="text-center border poll-select-container ordem7_col"><small className="text-muted">2ºB</small></th>
                            <th colSpan="4" className="text-center border poll-select-container ordem7_col"><small className="text-muted">4ºB</small></th>
                        </tr>
                        <tr>
