        ...
        return (
            <tr>
                ...
                <th colSpan="2" className="text-center border poll-select-container ordem8_col">
                    <PollSelectRightWrong sequence={this.props.student.studentCodeEol} name="orderm8Ideia1S" value={this.props.student.orderm8Ideia1S} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale" disabled={this.props.editLock1S}/>
                </th>
                <th colSpan="2" className="text-center border poll-select-container ordem8_col">
                    <PollSelectRightWrong sequence={this.props.student.studentCodeEol} name="orderm8Resultado1S" value={this.props.student.orderm8Resultado1S} updatePollStudent={this.props.updatePollStudent} columnColor="bg-lila" disabled={this.props.editLock1S}/>
                </th>
                <th colSpan="2" className="text-center border poll-select-container ordem8_col">
                    <PollSelectRightWrong sequence={this.props.student.studentCodeEol} name="orderm8Ideia2S" value={this.props.student.orderm8Ideia2S} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale" disabled={this.props.editLock2S}/>
                </th>
                <th colSpan="2" className="text-center border poll-select-container ordem8_col">
                    <PollSelectRightWrong sequence={this.props.student.studentCodeEol} name="orderm8Resultado2S" value={this.props.student.orderm8Resultado2S} updatePollStudent={this.props.updatePollStudent} columnColor="bg-lila" disabled={this.props.editLock2S}/>
                </th>
            </tr>
        );
    }
