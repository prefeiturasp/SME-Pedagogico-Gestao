        ...
        return (
            <tr>
                ...
                <th className="text-center border poll-select-container 1bim_col">
                    <PollSelectReadWriteLevel subjectName="portuguese" sequence={this.props.student.sequence} name="t1e" value={this.props.student.pollresults.portuguese.t1e} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale" />
                </th>
                <th className="text-center border poll-select-container 1bim_col">
                ...
                <th className="text-center border poll-select-container 2bim_col">
                    <PollSelectReadWriteLevel subjectName="portuguese" sequence={this.props.student.sequence} name="t2e" value={this.props.student.pollresults.portuguese.t2e} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale"/>
                </th>
                <th className="text-center border poll-select-container 2bim_col">
                ...
                <th className="text-center border poll-select-container 3bim_col">
                    <PollSelectReadWriteLevel subjectName="portuguese" sequence={this.props.student.sequence} name="t3e" value={this.props.student.pollresults.portuguese.t3e} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale"/>
                </th>
                <th className="text-center border poll-select-container 3bim_col">
                ...
                <th className="text-center border poll-select-container 4bim_col">
                    <PollSelectReadWriteLevel subjectName="portuguese" sequence={this.props.student.sequence} name="t4e" value={this.props.student.pollresults.portuguese.t4e} updatePollStudent={this.props.updatePollStudent} columnColor="bg-bluescale"/>
                </th>
                <th className="text-center border poll-select-container 4bim_col">
