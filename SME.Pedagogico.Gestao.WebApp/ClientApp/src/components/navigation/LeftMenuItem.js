...
export default class LeftMenuItem extends Component {
    ...
    menuItemClicked(event) {
        this.props.selectMenuSubItem(this.props.menuItem.name, event.target.innerText);
    }
                    ...
                    {toggle => toggle && (props =>
                        <animated.div className="open-left-menu w-100 d-flex flex-column align-content-start align-items-center" style={props}>
                            {this.props.menuItem.subitems.map(item =>
                                <div key={item.name} className="w-100 d-flex align-items-center py-1" onClick={this.menuItemClicked}>
