...
class TopMenu extends Component {
  ...
  componentWillMount() {
    if (
      permissoes.EditarEConsultar(this.props.user) ||
      permissoes.ApenasConsultas(this.props.user)
    ) {
      this.setVisiblePoll();
    ...
    return (
      <div id="top-menu" className="d-flex w-auto">
        <TwoSteps
          ...
          runMethod={this.changeRoutePoll}
        />
        ...
        <div id="top-menu-bar" className="d-flex flex-fill align-items-center">
          ...
          <div className="d-flex h-100">
            {this.state.isVisible && (
              <div
                className={
                  this.props.pollRouter.activeRoute === "Sondagem"
            ...
            <div
              className={
                this.props.pollRouter.activeRoute === "Relatórios"
            ...
            >
              <Link
                ...
                onClick={this.changeRoutePollReport}
              >
                <small className="mx-3 font-weight-light text-muted">
                  Relat&oacute;rios
                </small>
          ...
          <div className="d-flex">
            <small className="d-flex align-items-center font-weight-light text-muted">
              {this.props.user.perfil.perfilSelecionado.nomePerfil}
            </small>
...
export default connect(
  ...
  (dispatch) => ({
    userMethods: bindActionCreators(actionCreators, dispatch),
    pollRouterMethods: bindActionCreators(pollRouterActionCreators, dispatch),
    dataMethods: bindActionCreators(dataActionCreators, dispatch),
  })
)(TopMenu);
